...
int main() {
    ...
    for (int i = 0; i <
                    5; i++) {    // aca declara la variable "i" como numero entero para que arranque en "0"... no entiendo lo que sigue.. que "i" tiene que ser menor que "5"?? despues a i e suma un numero????
